...
public class PolicyHandler{
    ...
    @StreamListener(value=KafkaProcessor.INPUT, condition="headers['type']=='SreamProcessed'")
    public void wheneverSreamProcessed_NotifyToUser(@Payload SreamProcessed sreamProcessed){
